...
public class AddAllSelectableReceivingOrganisationsToContract extends CustomJavaAction<java.util.List<IMendixObject>>
{
	private IMendixObject __ContractParameter1;
	private slm.proxies.Contract ContractParameter1;

	public AddAllSelectableReceivingOrganisationsToContract(IContext context, IMendixObject ContractParameter1)
	{
		super(context);
	...
	public java.util.List<IMendixObject> executeAction() throws Exception
	{
		...
		LinkedList<IMendixObject> resultIMendixObjectContractList = new LinkedList<IMendixObject>();
		for(Iterator<Organisation> listIterator = list.iterator(); listIterator.hasNext(); ){
			resultIMendixObjectContractList.add(listIterator.next().getMendixObject());
		}
		return resultIMendixObjectContractList;
		// END USER CODE
	}
	...
	{
		return "AddAllSelectableReceivingOrganisationsToContract";
	}
