...
public class BusinessTimeDiff extends CustomJavaAction<java.lang.Long>
{
	...
	public BusinessTimeDiff(IContext context, java.util.Date Start, java.util.Date Stop, IMendixObject BusinessTimesGroup, IMendixObject HolidaysGroup)
	{
		super(context);
		this.Start = Start;
		this.Stop = Stop;
	...
	public java.lang.Long executeAction() throws Exception
	{
		...
		try {
			...
			if (this.BusinessTimesGroup==null) {
				Core.getLogger("BusinessHours").error("BusinessHoursCalculation: Diff missing Business Times Group");
				return null;
			}
			if (this.Start==null) { 
				Core.getLogger("BusinessHours").error("BusinessHoursCalculation: Diff missing Start");
				return null;
			}
			if (this.Stop==null) { 
				Core.getLogger("BusinessHours").error("BusinessHoursCalculation: Diff missing Stop");
				return null;
			}
			Core.getLogger("BusinessHours").trace("BusinessHoursCalculation: Diff " + this.Start + " - " + this.Stop +
			...
			long result = calendarHours.diffTime(start, stop);
			Core.getLogger("BusinessHours").trace("BusinessHoursCalculation: Diff result is " + result);
			return result;
