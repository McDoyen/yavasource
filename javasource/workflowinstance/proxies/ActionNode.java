...
public class ActionNode extends workflowinstance.proxies.Node
{
	/**
	 * Internal name of this entity
	 */
	public static final java.lang.String entityName = "WorkflowInstance.ActionNode";
	...
	public enum MemberNames
	{
		...
		ActionNode_Transition("WorkflowInstance.ActionNode_Transition"),
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "WorkflowInstance.ActionNode"));
	}
	...
	protected ActionNode(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject actionNodeMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("WorkflowInstance.ActionNode", actionNodeMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a WorkflowInstance.ActionNode");
	}
	 ...
	 */
	@Deprecated
	public static workflowinstance.proxies.ActionNode initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return workflowinstance.proxies.ActionNode.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static workflowinstance.proxies.ActionNode initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new workflowinstance.proxies.ActionNode(context, mendixObject);
	}

	public static workflowinstance.proxies.ActionNode load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return workflowinstance.proxies.ActionNode.initialize(context, mendixObject);
	}

	public static java.util.List<workflowinstance.proxies.ActionNode> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<workflowinstance.proxies.ActionNode> result = new java.util.ArrayList<workflowinstance.proxies.ActionNode>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//WorkflowInstance.ActionNode" + xpathConstraint))
			result.add(workflowinstance.proxies.ActionNode.initialize(context, obj));
		return result;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final workflowinstance.proxies.ActionNode that = (workflowinstance.proxies.ActionNode) obj;
	...
	{
		return "WorkflowInstance.ActionNode";
	}
