...
public class SignalNode extends workflowinstance.proxies.Node
{
	/**
	 * Internal name of this entity
	 */
	public static final java.lang.String entityName = "WorkflowInstance.SignalNode";
	...
	public enum MemberNames
	{
		...
		SignalNode_WorkflowSignal("WorkflowInstance.SignalNode_WorkflowSignal"),
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "WorkflowInstance.SignalNode"));
	}
	...
	protected SignalNode(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject signalNodeMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("WorkflowInstance.SignalNode", signalNodeMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a WorkflowInstance.SignalNode");
	}
	 ...
	 */
	@Deprecated
	public static workflowinstance.proxies.SignalNode initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return workflowinstance.proxies.SignalNode.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static workflowinstance.proxies.SignalNode initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new workflowinstance.proxies.SignalNode(context, mendixObject);
	}

	public static workflowinstance.proxies.SignalNode load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return workflowinstance.proxies.SignalNode.initialize(context, mendixObject);
	}

	public static java.util.List<workflowinstance.proxies.SignalNode> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<workflowinstance.proxies.SignalNode> result = new java.util.ArrayList<workflowinstance.proxies.SignalNode>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//WorkflowInstance.SignalNode" + xpathConstraint))
			result.add(workflowinstance.proxies.SignalNode.initialize(context, obj));
		return result;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final workflowinstance.proxies.SignalNode that = (workflowinstance.proxies.SignalNode) obj;
	...
	{
		return "WorkflowInstance.SignalNode";
	}
