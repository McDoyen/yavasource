...
public class FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("InterfaceAttachments.Attachment", mendixObject.getType()))
			return interfaceattachments.proxies.Attachment.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("SDEMigration.AuditCIPDF", mendixObject.getType()))
			return sdemigration.proxies.AuditCIPDF.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("Audit.AuditFileDocument", mendixObject.getType()))
			return audit.proxies.AuditFileDocument.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("SDEMigration.AuditPDF", mendixObject.getType()))
			return sdemigration.proxies.AuditPDF.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("CMDB.CMDBAttachment", mendixObject.getType()))
			return cmdb.proxies.CMDBAttachment.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("CMDB.CMDBTypeAttachments", mendixObject.getType()))
			return cmdb.proxies.CMDBTypeAttachments.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("SLM.ContractAttachment", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("Process.Document", mendixObject.getType()))
			return process.proxies.Document.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("TestCases.Document", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("ImportExport.ImportExportSetting", mendixObject.getType()))
			return importexport.proxies.ImportExportSetting.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("InterfaceShared_FileImport.IncomingFile", mendixObject.getType()))
			return interfaceshared_fileimport.proxies.IncomingFile.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("ImportExport.JobFile", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("EmailPlus.MessageAttachment", mendixObject.getType()))
			return emailplus.proxies.MessageAttachment.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("CustomLVNL.NOTAMDoc", mendixObject.getType()))
			return customlvnl.proxies.NOTAMDoc.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("CustomLVNL.NOTAMTemplate", mendixObject.getType()))
			return customlvnl.proxies.NOTAMTemplate.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("ServiceCatalogue.ProductFiles", mendixObject.getType()))
			return servicecatalogue.proxies.ProductFiles.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("ServiceCatalogue.ProductToBeAddedAttributeAttachment", mendixObject.getType()))
			return servicecatalogue.proxies.ProductToBeAddedAttributeAttachment.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("Reporting.ReportSelect", mendixObject.getType()))
			return reporting.proxies.ReportSelect.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("Process.RequestAttachment", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("SLM.ServiceProcessDoc", mendixObject.getType()))
			return slm.proxies.ServiceProcessDoc.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("ServiceCatalogue.ShoppingCartProductAttributeAttachment", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("Scheduling.TemplateRequestAttachment", mendixObject.getType()))
			return scheduling.proxies.TemplateRequestAttachment.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("TestCases.TestAttachments", mendixObject.getType()))
			return testcases.proxies.TestAttachments.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("NAP.UU95_Document", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("CustomLVNL.ZipFile", mendixObject.getType()))
