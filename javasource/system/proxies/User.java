...
public class User
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("Mendix.Account", mendixObject.getType()))
	 ...
	 */
	public final process.proxies.ProgressViewPreferences getProgressViewPreferences_User() throws com.mendix.core.CoreException
	{
	 ...
	 * @return value of ProgressViewPreferences_User
	 */
	public final process.proxies.ProgressViewPreferences getProgressViewPreferences_User(com.mendix.systemwideinterfaces.core.IContext context) throws com.mendix.core.CoreException
	{
		process.proxies.ProgressViewPreferences result = null;
		...
		if (identifier != null)
			result = process.proxies.ProgressViewPreferences.load(context, identifier);
		return result;
	}
	 ...
	 */
	public final void setProgressViewPreferences_User(process.proxies.ProgressViewPreferences progressviewpreferences_user)
	{
	 ...
	 * @param progressviewpreferences_user
	 */
	public final void setProgressViewPreferences_User(com.mendix.systemwideinterfaces.core.IContext context, process.proxies.ProgressViewPreferences progressviewpreferences_user)
	{
