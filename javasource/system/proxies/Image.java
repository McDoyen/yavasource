...
public class Image extends system.proxies.FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("QuestionnaireV2.ImageAnswer", mendixObject.getType()))
			return questionnairev2.proxies.ImageAnswer.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("EmailPlus.MessageImage", mendixObject.getType()))
			return emailplus.proxies.MessageImage.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("NAP.PersonImage", mendixObject.getType()))
			return nap.proxies.PersonImage.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("Portal.PortalQuickCallImage", mendixObject.getType()))
			return portal.proxies.PortalQuickCallImage.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("ServiceCatalogue.ProductImage", mendixObject.getType()))
			return servicecatalogue.proxies.ProductImage.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("Process.RequestImages", mendixObject.getType()))
			return process.proxies.RequestImages.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("ServiceCatalogue.ShoppingCart", mendixObject.getType()))
			return servicecatalogue.proxies.ShoppingCart.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("CMS.StartPageImages", mendixObject.getType()))
