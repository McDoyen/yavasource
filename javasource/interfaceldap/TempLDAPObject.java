...
public class TempLDAPObject {
	...
	private HashMap<String, TempLDAPAttribute> properties;
	...
	public TempLDAPObject(String dn) {
    	this.properties = new HashMap<String, TempLDAPAttribute>();
    ...
    public void setProperty(String property, String value, boolean mappable) {
    	properties.put(property, new TempLDAPAttribute(property, value, mappable));
    }
    ...
    public TempLDAPAttribute getTempLDAPAttribute(String fieldName) throws MendixException {
    	TempLDAPAttribute tempLDAPAttribute = properties.get(fieldName);
    	if (tempLDAPAttribute == null) 
    		throw new MendixException("Field '"+fieldName+"' not found in ldap directory '"+getModifiedDn()+"'");
    	return tempLDAPAttribute;
    }
