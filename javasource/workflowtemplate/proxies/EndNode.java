...
public class EndNode extends workflowtemplate.proxies.Node
{
	/**
	 * Internal name of this entity
	 */
	public static final java.lang.String entityName = "WorkflowTemplate.EndNode";
	...
	public enum MemberNames
	{
		...
		EndNode_ResultNode("WorkflowTemplate.EndNode_ResultNode"),
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "WorkflowTemplate.EndNode"));
	}
	...
	protected EndNode(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject endNodeMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("WorkflowTemplate.EndNode", endNodeMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a WorkflowTemplate.EndNode");
	}
	 ...
	 */
	@Deprecated
	public static workflowtemplate.proxies.EndNode initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return workflowtemplate.proxies.EndNode.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static workflowtemplate.proxies.EndNode initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new workflowtemplate.proxies.EndNode(context, mendixObject);
	}

	public static workflowtemplate.proxies.EndNode load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return workflowtemplate.proxies.EndNode.initialize(context, mendixObject);
	}

	public static java.util.List<workflowtemplate.proxies.EndNode> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<workflowtemplate.proxies.EndNode> result = new java.util.ArrayList<workflowtemplate.proxies.EndNode>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//WorkflowTemplate.EndNode" + xpathConstraint))
			result.add(workflowtemplate.proxies.EndNode.initialize(context, obj));
		return result;
	}
	 ...
	 */
	public final workflowtemplate.proxies.Node getEndNode_ResultNode() throws com.mendix.core.CoreException
	{
	 ...
	 * @return value of EndNode_ResultNode
	 */
	public final workflowtemplate.proxies.Node getEndNode_ResultNode(com.mendix.systemwideinterfaces.core.IContext context) throws com.mendix.core.CoreException
	{
	 ...
	 */
	public final void setEndNode_ResultNode(workflowtemplate.proxies.Node endnode_resultnode)
	{
	 ...
	 * @param endnode_resultnode
	 */
	public final void setEndNode_ResultNode(com.mendix.systemwideinterfaces.core.IContext context, workflowtemplate.proxies.Node endnode_resultnode)
	{
	...
	public boolean equals(Object obj)
	{
		...
		{
			final workflowtemplate.proxies.EndNode that = (workflowtemplate.proxies.EndNode) obj;
	...
	{
		return "WorkflowTemplate.EndNode";
	}
