...
public class Operation extends process.proxies.Request
{
	/**
	 * Internal name of this entity
	 */
	public static final java.lang.String entityName = "Process.Operation";
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "Process.Operation"));
	}
	...
	protected Operation(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject operationMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("Process.Operation", operationMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a Process.Operation");
	}

	/**
	 * @deprecated Use 'Operation.load(IContext, IMendixIdentifier)' instead.
	 */
	@Deprecated
	public static process.proxies.Operation initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return process.proxies.Operation.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static process.proxies.Operation initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new process.proxies.Operation(context, mendixObject);
	}

	public static process.proxies.Operation load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return process.proxies.Operation.initialize(context, mendixObject);
	}

	public static java.util.List<process.proxies.Operation> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<process.proxies.Operation> result = new java.util.ArrayList<process.proxies.Operation>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//Process.Operation" + xpathConstraint))
			result.add(process.proxies.Operation.initialize(context, obj));
		return result;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final process.proxies.Operation that = (process.proxies.Operation) obj;
