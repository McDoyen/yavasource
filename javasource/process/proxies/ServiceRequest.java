...
public class ServiceRequest extends process.proxies.Request
{
	/**
	 * Internal name of this entity
	 */
	public static final java.lang.String entityName = "Process.ServiceRequest";
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "Process.ServiceRequest"));
	}
	...
	{
		super(context, serviceRequestMendixObject);
		if (!com.mendix.core.Core.isSubClassOf("Process.ServiceRequest", serviceRequestMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a Process.ServiceRequest");
	}
	 ...
	 */
	@Deprecated
	public static process.proxies.ServiceRequest initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return process.proxies.ServiceRequest.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static process.proxies.ServiceRequest initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new process.proxies.ServiceRequest(context, mendixObject);
	}

	public static process.proxies.ServiceRequest load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return process.proxies.ServiceRequest.initialize(context, mendixObject);
	}

	public static java.util.List<process.proxies.ServiceRequest> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<process.proxies.ServiceRequest> result = new java.util.ArrayList<process.proxies.ServiceRequest>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//Process.ServiceRequest" + xpathConstraint))
			result.add(process.proxies.ServiceRequest.initialize(context, obj));
		return result;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final process.proxies.ServiceRequest that = (process.proxies.ServiceRequest) obj;
