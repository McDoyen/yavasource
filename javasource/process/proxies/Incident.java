...
public class Incident extends process.proxies.Request
{
	/**
	 * Internal name of this entity
	 */
	public static final java.lang.String entityName = "Process.Incident";
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "Process.Incident"));
	}
	...
	protected Incident(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject incidentMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("Process.Incident", incidentMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a Process.Incident");
	}
	 ...
	 */
	@Deprecated
	public static process.proxies.Incident initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return process.proxies.Incident.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static process.proxies.Incident initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new process.proxies.Incident(context, mendixObject);
	}

	public static process.proxies.Incident load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return process.proxies.Incident.initialize(context, mendixObject);
	}

	public static java.util.List<process.proxies.Incident> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<process.proxies.Incident> result = new java.util.ArrayList<process.proxies.Incident>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//Process.Incident" + xpathConstraint))
			result.add(process.proxies.Incident.initialize(context, obj));
		return result;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final process.proxies.Incident that = (process.proxies.Incident) obj;
