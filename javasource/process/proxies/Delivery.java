...
public class Delivery extends process.proxies.Request
{
	/**
	 * Internal name of this entity
	 */
	public static final java.lang.String entityName = "Process.Delivery";
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "Process.Delivery"));
	}
	...
	{
		super(context, deliveryMendixObject);
		if (!com.mendix.core.Core.isSubClassOf("Process.Delivery", deliveryMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a Process.Delivery");
	}
	 ...
	 */
	@Deprecated
	public static process.proxies.Delivery initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return process.proxies.Delivery.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static process.proxies.Delivery initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new process.proxies.Delivery(context, mendixObject);
	}

	public static process.proxies.Delivery load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return process.proxies.Delivery.initialize(context, mendixObject);
	}

	public static java.util.List<process.proxies.Delivery> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<process.proxies.Delivery> result = new java.util.ArrayList<process.proxies.Delivery>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//Process.Delivery" + xpathConstraint))
			result.add(process.proxies.Delivery.initialize(context, obj));
		return result;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final process.proxies.Delivery that = (process.proxies.Delivery) obj;
