...
public class Problem extends process.proxies.Request
{
	/**
	 * Internal name of this entity
	 */
	public static final java.lang.String entityName = "Process.Problem";
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "Process.Problem"));
	}
	...
	protected Problem(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject problemMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("Process.Problem", problemMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a Process.Problem");
	}
	 ...
	 */
	@Deprecated
	public static process.proxies.Problem initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return process.proxies.Problem.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static process.proxies.Problem initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new process.proxies.Problem(context, mendixObject);
	}

	public static process.proxies.Problem load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return process.proxies.Problem.initialize(context, mendixObject);
	}

	public static java.util.List<process.proxies.Problem> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<process.proxies.Problem> result = new java.util.ArrayList<process.proxies.Problem>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//Process.Problem" + xpathConstraint))
			result.add(process.proxies.Problem.initialize(context, obj));
		return result;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final process.proxies.Problem that = (process.proxies.Problem) obj;
