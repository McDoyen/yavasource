...
import saml20.implementation.ArtifactHandler;
import saml20.implementation.DelegatedAuthenticationHandler;
import saml20.implementation.DiscoveryHandler;
import saml20.implementation.LoginHandler;
import saml20.implementation.LogoutHandler;
import saml20.implementation.MetadataHandler;
import saml20.implementation.SAMLHandler;
...
public class Constants {
		...
		try {
			...
			if (input != null) {
				try {
					...
					Core.getLogger(LOGNODE).debug( "Unable to close after reading the resource file", e);
				}
			}
		}
	...
	public static final String getLandingPage() {
		...
		String indexpage = "index.html", indexconfig = (constant != null ? constant.toString().trim() : null);
