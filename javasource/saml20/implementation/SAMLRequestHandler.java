...
//				throw new SAMLFeedbackException("There is no active SSO Configuration available. Please review your configuration.");
//			}
	...
	public void processRequest( IMxRuntimeRequest request, IMxRuntimeResponse response, String arguments ) {
		try {
			...
			if ( this.handlers.containsKey(action) ) {
				...
				throw new SAMLFeedbackException("Unsupported action: [" + resourceArgs[0] + "], only " + this.handlers.keySet() + " are supported.");
			}
		}
		catch( Exception e ) {
