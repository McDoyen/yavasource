...
public class SPMetadata extends IMetadata {
	...
	public SPMetadata updateConfiguration( IContext context, IMendixObject spMetadata, CredentialRepository credentialRepository ) throws SAMLException {
		ByteArrayOutputStream out = SPMetadataGenerator.generate(context, spMetadata, credentialRepository);

		InputStream inputStream = new ByteArrayInputStream(out.toByteArray());

		String preferredEntityId = (String) spMetadata.getValue(context, saml20.proxies.SPMetadata.MemberNames.EntityID.toString());
