...
public class CertificateHandler {
	...
	public static String getCertificateContents( String tagValue ) throws CertificateException, IOException {
		...
		InputStream inStream = new ByteArrayInputStream(tagValue.getBytes("UTF-8"));

		CertificateFactory cf = CertificateFactory.getInstance("X.509");
		Certificate cert = cf.generateCertificate(inStream); // breaks here in V4
		inStream.close();
	...
	public static String getBase64Content( IContext context, IMendixObject certObj ) throws IOException {
		InputStream inputStream = Core.getFileDocumentContent(context, certObj);
