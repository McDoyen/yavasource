...
public class CreateSSOMetadataFile extends CustomJavaAction<java.lang.Boolean>
{
	...
	public java.lang.Boolean executeAction() throws Exception
	{
		...
		ByteArrayOutputStream out = SPMetadataGenerator.generate(getContext(), this.__spMetadata, credRep );
		
		this.spMetadata.setName("sp_metadata.xml");
		Core.storeFileDocumentContent(getContext(), this.__spMetadata, new ByteArrayInputStream(out.toByteArray()));
