...
public class ExecuteMicroflow_2 extends CustomJavaAction<java.lang.Boolean>
{
	...
	public ExecuteMicroflow_2(IContext context, java.lang.String microflowName, java.lang.String arg1name, IMendixObject arg1value, java.lang.String arg2name, IMendixObject arg2value)
	{
		super(context);
	...
	{
		// BEGIN USER CODE
		Object[] args = new Object[] {arg1name, arg1value, arg2name, arg2value};
		...
		if(params.size()!= attributes.size()){
			throw new Exception("Assertion: Wrong number of parameters for this microflow, the microflow requires " + attributes.size() + " parameter(s), this ExecuteMicroflow java action provides two parameters.");
		}		
		return Core.execute(getContext(), microflowName, params);
		// END USER CODE
	}
