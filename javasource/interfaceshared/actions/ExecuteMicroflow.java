...
public class ExecuteMicroflow extends CustomJavaAction<java.lang.Boolean>
{
	private java.lang.String microflowName;

	public ExecuteMicroflow(IContext context, java.lang.String microflowName)
	{
		super(context);
	...
	public java.lang.Boolean executeAction() throws Exception
	{
		...
		if(params.size()!= attributes.size()){
			throw new Exception("Assertion: Wrong number of parameters for this microflow, the microflow requires " + attributes.size() + " parameter(s), this ExecuteMicroflow java action provides no parameters.");
		}		
