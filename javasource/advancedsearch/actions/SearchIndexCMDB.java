...
public class SearchIndexCMDB extends CustomJavaAction<IMendixObject>
{
	private IMendixObject __params;
	private advancedsearch.proxies.SearchParams params;

	public SearchIndexCMDB(IContext context, IMendixObject params)
	{
		super(context);
	...
	public IMendixObject executeAction() throws Exception
	{
		...
		nl.mansystems.advancedsearch.SearchIndexCMDB asic = 
				new nl.mansystems.advancedsearch.SearchIndexCMDB(this.getContext(), params);		
		
		try {			
			identifiers = asic.executeAction();
		...
		if (identifiers != null)
			params.getMendixObject().setValue(context, SearchParams.MemberNames.SearchParams_ConfigurationItem.toString(), identifiers);
