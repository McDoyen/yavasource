...
public class SearchIndexProduct extends CustomJavaAction<IMendixObject>
{
	private IMendixObject __params;
	private advancedsearch.proxies.SearchParams params;

	public SearchIndexProduct(IContext context, IMendixObject params)
	{
		super(context);
	...
	public IMendixObject executeAction() throws Exception
	{
		...
		nl.mansystems.advancedsearch.SearchIndexWebshop asir = 
				new nl.mansystems.advancedsearch.SearchIndexWebshop(this.getContext(), params);
		...
		if (identifiers != null)
			params.getMendixObject().setValue(context, SearchParams.MemberNames.SearchParams_Product.toString(), identifiers);
