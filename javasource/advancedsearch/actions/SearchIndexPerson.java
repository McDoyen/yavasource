...
public class SearchIndexPerson extends CustomJavaAction<IMendixObject>
{
	private IMendixObject __params;
	private advancedsearch.proxies.SearchParams params;

	public SearchIndexPerson(IContext context, IMendixObject params)
	{
		super(context);
	...
	public IMendixObject executeAction() throws Exception
	{
		...
		nl.mansystems.advancedsearch.SearchIndexPerson asir = 
				new nl.mansystems.advancedsearch.SearchIndexPerson(this.getContext(), params);
		...
		if (identifiers != null)
			params.getMendixObject().setValue(context, SearchParams.MemberNames.SearchParams_Person.toString(), identifiers);
